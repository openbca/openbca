...
MEASURES_SCHEMA_COLUMN_ORDER = [
    ...
    "avoided_credit_and_collection_cost_annual_dollar_per_year",
...
columns={
    ...
    "start_year": "int",
    "start_quarter": "int",
    "measure_specific_discount_rate": "float", 
    "measure_unit": "string",
    "unit_quantity": "float",
    ...
    "utility_direct_investment_in_ders_upfront_dollar": "float",
    "avoided_credit_and_collection_cost_annual_dollar_per_year": "float",
    ...
    "incremental_cost_annual_dollar_per_year": "float",
    "host_customer_transaction_cost_upfront_dollar": "float",
    "host_customer_interconnection_cost_upfront_dollar": "float",
    ...
    "host_customer_non_energy_impacts_upfront_dollar": "float",
    "host_customer_non_energy_impacts_low_income_upfront_dollar": "float",
