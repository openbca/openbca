...
gas_calculations AS (
    ...
    GROUP BY pcwdga.project_id, pcwdga.eul, pcwdga.datetime, therms_profile.profile_name
    )
...
, elec_calculations.value_curve_name
