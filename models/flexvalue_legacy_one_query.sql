...
WITH project_costs AS (
    ...
    FROM
    flexvalue_input.project_info project_info
),
project_costs_with_discounted_elec_av AS (
    ...
    FROM project_costs
    JOIN
        flexvalue_reference.elec_av_costs elec_av_costs
...
elec_calculations AS (
    ...
    JOIN flexvalue_reference.elec_load_shape_unpivoted elec_load_shape
