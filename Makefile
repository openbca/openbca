...
refresh-ref-output:
	duckdb output/duckdb.db "COPY flexvalue.project_value_stream_benefits TO 'california/data/test_real_data_calculations_aggregated/rdc_output_table.csv' (HEADER, DELIMITER ',');"
